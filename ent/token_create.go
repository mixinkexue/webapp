...
func (tc *TokenCreate) SetVal(s string) *TokenCreate {
	tc.mutation.SetVal(s)
	return tc
}

// SetOwnerID sets the "owner" edge to the User entity by ID.
func (tc *TokenCreate) SetOwnerID(id int) *TokenCreate {
	tc.mutation.SetOwnerID(id)
	return tc
}

// SetNillableOwnerID sets the "owner" edge to the User entity by ID if the given value is not nil.
func (tc *TokenCreate) SetNillableOwnerID(id *int) *TokenCreate {
	if id != nil {
		tc = tc.SetOwnerID(*id)
	}
	return tc
...
func (tc *TokenCreate) check() error {
	if _, ok := tc.mutation.Val(); !ok {
		return &ValidationError{Name: "val", err: errors.New(`ent: missing required field "Token.val"`)}
	}
	return nil
}
...
func (tc *TokenCreate) createSpec() (*Token, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.Val(); ok {
		_spec.SetField(token.FieldVal, field.TypeString, value)
		_node.Val = value
	}
