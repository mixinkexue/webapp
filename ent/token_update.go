...
func (tu *TokenUpdate) SetVal(s string) *TokenUpdate {
	tu.mutation.SetVal(s)
	return tu
}
...
func (tu *TokenUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Val(); ok {
...
// SetVal sets the "val" field.
func (tuo *TokenUpdateOne) SetVal(s string) *TokenUpdateOne {
	tuo.mutation.SetVal(s)
	return tuo
}
...
func (tuo *TokenUpdateOne) sqlSave(ctx context.Context) (_node *Token, err error) {
	...
	if value, ok := tuo.mutation.Val(); ok {
		_spec.SetField(token.FieldVal, field.TypeString, value)
	}
